...
@toolbox.tool
def talk_to_developer(message: str):
    """
    Use this function to communicate with the developer.
    All communication to and from the developer **MUST**
    be through this tool.
    :param message: The message to send to the developer.
